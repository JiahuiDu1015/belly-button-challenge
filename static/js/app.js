...
function buildMetadata(sample) {
  d3.json("https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
    ...
    // Ensure metadataResult is found
    if (!result) {
      console.error(`Metadata for sample ${sample} not found`);
      return;
    }
...
function buildCharts(sample) {
  d3.json("https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
    ...
    let bubbleLayout = {
      ...
      yaxis: { title: "Number of Bateria" } // Y-axis label
    };
    ...
    let barLayout = {
      ...
      margin: { t: 30, l: 150 },
      xaxis: { title: "Number of Bateria" }, // X-axis label
    };
